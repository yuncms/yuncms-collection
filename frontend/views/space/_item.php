...
<?php if ($type == 'questions'): ?>
    ...
    <div class="bookmark-rank">
        <div class="collections">
            ...
            <small><?=Yii::t('collection','Collection')?></small>
        </div>
    </div>
    <div class="summary">
        <ul class="author list-inline">
            <li>
                <a href="<?= Url::to(['/user/space/view', 'id' => $collection->user_id]) ?>"><?= $collection->user->nickname ?></a>
        ...
        <div class="live-content">
            ...
            <div class="live-info">
                <object><a href="<?= Url::to(['/user/space/view', 'id' => $collection->user_id]) ?>"><span
                                class="program-info-name"><?= $collection->user->nickname; ?></span></a></object>
                ·
